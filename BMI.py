...
def BMI():
    ...
    if bmi <= 18.5:
        ...
        label3.config(text="You have lower weight then normal")
    elif bmi > 18.5 and bmi <= 25:
        label2.config(text="Normal!!")
        label3.config(text="You are healthy")
    elif bmi > 25 and bmi <= 30:
        label2.config(text="Overweight!!")
        label3.config(text="Fat")
    else:
        label2.config(text="Obes")
        label3.config(text="Risk Zone")


# icon
image_icon = PhotoImage(
    file="C:/Users/vaska/OneDrive/Desktop/Python/BMI Calculator/images/icon.png")
root.iconphoto(True, image_icon)

# top
top = PhotoImage(
    file="C:/Users/vaska/OneDrive/Desktop/Python/BMI Calculator/images/top.png")
top_image = Label(root, image=top, background="#f0f1f5")
top_image.place(x=- 20, y=-10)
...
# two boxes
box = PhotoImage(
    file="C:/Users/vaska/OneDrive/Desktop/Python/BMI Calculator/images/box.png")
Label(root, image=box).place(x=20, y=100)
Label(root, image=box).place(x=240, y=100)

# scale
scale = PhotoImage(
    file="C:/Users/vaska/OneDrive/Desktop/Python/BMI Calculator/images/scale.png")
Label(root, image=scale, bg="lightblue").place(x=20, y=320)
...
def slider_changed(event):
    ...
    img = (Image.open(
        "C:/Users/vaska/OneDrive/Desktop/Python/BMI Calculator/images/man.png"))
...
Button(root, text="View Report", width=15, height=2, font="arial 10 bold",
       bg='#1f6e68', fg='black', command=BMI).place(x=280, y=340)

label1 = Label(root, font="arial 40 bold", bg="lightblue", fg="#fff")
label1.place(x=125, y=305)

label2 = Label(root, font="arial 20 bold", bg="lightblue", fg="#fff")
label2.place(x=125, y=385)

label3 = Label(root, font="arial 10 bold", bg="lightblue", fg="#fff")
label3.place(x=125, y=425)
